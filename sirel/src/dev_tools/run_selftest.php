...
<html>
    ...
    <body>
		...
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_core_utilities.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_lang.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_type_normalizations.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_units.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_math_boolean.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_operators.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_operators_set_1.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_bigint_t1.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_ix.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_guid.php');
		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_sirel_security_utilities.php');

		require_once ($s_path_lib_sirel.'/src/dev_tools/selftests/test_various_1.php');
